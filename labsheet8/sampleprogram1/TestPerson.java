...
public class TestPerson
{
    public static void main(String[] args)
    {
        ...
        text += "\n\nCalling the Person(String,String,GregorianCalendar) constructor after " +
                "getting user-supplied values .....";
        ...
        String dateOfBirth = JOptionPane.showInputDialog("Please enter the date of birth of the " +
                "second person in the form dd-mm-yyyy");
        ...
        text += "\n\nCalling the Student(String,String,GregorianCalendar,int,String) " +
                "constructor using hard-coded values .....";
